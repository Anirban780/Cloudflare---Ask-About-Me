/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 11bd571e7a18e06081007b171ca3fd52)
...
interface __BaseEnv_Env {
	...
	REPO_URL: "https://github.com/Anirban780/Cloudflare---Ask-About-Me.git";
	PortfolioAgent: DurableObjectNamespace<import("./src/server").PortfolioAgent>;
	INGEST_WORKFLOW: Workflow<Parameters<import("./src/server").IngestWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "PortfolioAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHAT_MODEL" | "RETRIEVAL_MODE" | "OWNER_NAME" | "OWNER_FIRST" | "AGENT_NAME" | "GITHUB_USER" | "TARGET_ROLES" | "REPO_URL">> {}
}
